...
import io.trino.tests.product.launcher.cli.suite.describe.json.JsonEnvironment;
        ...
        implements Callable<Integer>
{
            ...
            implements OutputBuilder
    {
        ...
        {
            sb.append(String.format("Suite '%s' with configuration '%s' consists of following test runs: \n", suiteName, config));
        }
            ...
            implements OutputBuilder
    {
        ...
        public void setConfig(String config)
        {
            output = new JsonOutput(config);
        }

        @Override
        public void addSuite(String suiteName)
        {
            JsonSuite suite = new JsonSuite(suiteName);
            output.getSuites().add(suite);
        }
        ...
        public void addTestRun(EnvironmentOptions environmentOptions, TestRun.TestRunOptions runOptions, Environment environment)
        {
            ...
            JsonTestRun testRun = new JsonTestRun(new JsonEnvironment(runOptions.environment, environment.getConfiguredConnectors()));
            ...
            implements Callable<Integer>
    {
                ...
                EnvironmentOptions environmentOptions)
        {
            ...
            this.outputBuilder = describeOptions.format == SuiteDescribeFormat.TEXT ? new TextOutputBuilder() : new JsonOutputBuilder();
